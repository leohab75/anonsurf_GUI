...
Для рф данная утилита не подходит, т.к. РКН заблокировал Тор. Но имеется рабочая тестовая версия связки Tor(client)+Redsocks(proxi/iptables)+snowflake(bridge)+cloudflared(dns), а подробнее: https://www.youtube.com/watch?v=ENc9Hm8u1xE
